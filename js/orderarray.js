...
// ORDINARE I NUMERI IN UN DATO ARRAY
 ...
 for (let i = 0; i < array.length; i++){
    ...
    //usiamo una variabile temporary che ci permetterà di scambiare  i due valori  senza far sovrascrivere l'ultimo al primo
    ...
    /*ESEMPIO se non avessimo usato una variabile temporale:
    array = ["a", "b"];
    array[0] = array[1];
    array[1] = array[0];
    Verrebbe fuori ['b', 'b'] perchè l'ultima variabile sovrascrive la prima. 
    Invece così dovrebbero invertirsi:
    let tmp = array[0];
    array[0] = array[1];
    array[1] = tmp;
    */
